...
Добро пожаловать в цикл разбора скриптового языка для (G)ZDoom-совместимых портов — ZScript!

!!! warning
    Внимание! Текст находится на ранних стадиях разработки. Пока что в нём будут встречаться неточности, непонятные формулировки, грамматические и (вероятно) фактические ошибки.
